	...
	public static void main(String[] args) {
		...
		for (int i=0; i<numberOfPlayers;i++) {
			...
			case 0:
				...
				players[0]=new Player(Case.PLAYER1, new Pawn(new Position(9, Board.TAILLE / 2), Case.PLAYER1));
				break;
			case 1:
				//players[1]=new Player(Case.PLAYER2, new Pawn(new Position(1, Board.TAILLE / 2), Case.PLAYER2));
				players[1]=new Player(Case.PLAYER2, new Pawn(new Position(11, Board.TAILLE / 2), Case.PLAYER2));
				break;
			case 2:
